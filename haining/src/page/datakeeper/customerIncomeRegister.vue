...
<el-row style="margin-top:10px">
  ...
  <el-col :span="6">
       <el-button type="info"  class="left" disabled>客户代理商</el-button><el-input clearable disabled v-model="addDocumentForm.agentCode"class="right" style="width:177px"></el-input>
  </el-col>
  <el-col :span="6">
